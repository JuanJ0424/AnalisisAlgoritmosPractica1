...
//Implementación del algoritmo de ordenamiento por burbuja optimizada
//Compilación: "gcc burbujaOptimizada.c tiempo.x  -o burbujaOptimizada(tiempo.c si se tiene la implementación de la libreria o tiempo.o si solo se tiene el codigo objeto)"
//Ejecución: "./burbujaOptimizada n" (Linux y MAC OS)
//*****************************************************************
...
void burbujaOptimizada(int *A, int n){
	...
	int cambios = 1; //Variable bandera para verificar si hubo swaps durante el recorrido del arreglo
	//******************************************************************
